...
function applyAppearanceFromSettings(settings: { darkMode?: boolean; designPreset?: DesignPreset; glassLevel?: GlassLevel }) {
  ...
  const ambiencePalette = THEME_AMBIENCE[settings.designPreset || 'aurora'];
  ...
  document.documentElement.style.setProperty('--bg-base-top', ambience.bgTop);
  document.documentElement.style.setProperty('--bg-base-bottom', ambience.bgBottom);
  document.documentElement.style.setProperty('--bg-orb-1', ambience.orb1);
  document.documentElement.style.setProperty('--bg-orb-2', ambience.orb2);
  document.documentElement.style.setProperty('--bg-grid', ambience.grid);
  document.documentElement.style.setProperty('--glass-tint-1', ambience.glassTint1);
  document.documentElement.style.setProperty('--glass-tint-2', ambience.glassTint2);
